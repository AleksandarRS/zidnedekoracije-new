 ...
 * 
*/
var GoogleMapsLomwnsr = require('google-maps'); // only for common js environments
GoogleMapsLomwnsr.KEY = theme.google_api_key;
...
let _this = module.exports = {
	...
	-------------------------------------------------------------------------------*/
	init: function () {
		GoogleMapsLomwnsr.load(function(google) {
